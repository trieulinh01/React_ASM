...
const ArticlePage = () => {
  ...
  <div className="article">
    <section className="article_content">
      <h1 className="article_content_title">Finibus Bonorum et Malorum</h1>
      <div className="article_content_note">
        <p className="note-author">Written by John doe</p>
        <p className="note-date">Monday May 20</p>
      </div>
      <hr />
      <div className="text">
        <p>
