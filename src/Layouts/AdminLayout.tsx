    ...
    <div className="flex min-h-screen w-full bg-[#f8f9fa]">
      ...
      <div className="flex-grow px-4 flex flex-col">
        <nav className="flex items-center justify-between py-2">
          <h6 className="font-bold capitalize text-slate-800">Blog admin</h6>
          <div className="flex items-center sm:flex-row flex-col-reverse">
            ...
            <div className="flex items-center">
              <a
                href="#"
                className="font-semibold text-sm text-white uppercase py-2.5 px-6 rounded-full bg-[#ec4899] ml-3"
              >
                login
              </a>
              <a
              ...
              <div className="group relative text-[#F27221] text-xl w-10 h-10 ml-4 flex items-center justify-center border border-[#ec4899] rounded-full cursor-pointer">
                <img
                  src="https://avatars.githubusercontent.com/u/107738933?s=400&u=63c4c7e25c79c97717c1b04cf460995a11114ea4&v=4"
                  alt=""
